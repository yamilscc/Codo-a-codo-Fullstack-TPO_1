...
.then(data => {
    ...
    console.log(data.cursos_italiano);

    for (let i = 0; i < data.cursos_italiano.length ; i++) {
        
        let elementoFila = copiaTabla.cloneNode(true);

        elementoFila.querySelector("#Tipo_Curso").textContent = data.cursos_italiano[i].Tipo_Curso;
        elementoFila.querySelector("#Curso").textContent = data.cursos_italiano[i].Curso;
        elementoFila.querySelector("#Profesor").textContent = data.cursos_italiano[i].Profesor;
        elementoFila.querySelector("#Nivel").textContent = data.cursos_italiano[i].Nivel;
        elementoFila.querySelector("#Duracion").textContent = data.cursos_italiano[i].Duracion + " meses";
